...
// DecodeDeposit decodes the Deposit instance encoded in resp body.
func (c *Client) DecodeDeposit(resp *http.Response) (*Deposit, error) {
	var decoded Deposit
...
// DecodePayment decodes the Payment instance encoded in resp body.
func (c *Client) DecodePayment(resp *http.Response) (*Payment, error) {
	var decoded Payment
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
